...
export const metadata: Metadata = {
  title: "Kinship — verify marriage eligibility with family graphs",
};
  ...
  return (
    <main className="landing-shell">
      <nav className="landing-nav">
        ...
        <Link className="nav-open" href="/signin">
          Open
        </Link>
      </nav>
      ...
      <section className="landing-hero">
        <div className="hero-copy">
          ...
          <div className="hero-buttons">
            <Link className="pink-action" href="/verify">
              <ShieldCheck size={18} />
              Start verification
            </Link>
            <Link className="text-action" href="/signin">
              Open registry
            </Link>
          </div>
      ...
      <section className="landing-cta">
        ...
        <Link className="pink-action" href="/signin">
          Open registry
          <ArrowRight size={18} />
        </Link>
      </section>
